module.exports = {
  ...
  offerScan: 'offerscan',
  certissuerNew: 'certissuernew',
  certissuerActivate: 'certissueractivate',
  certissuerUpdate: 'certissuerupdate',
  certNew: 'certnew',
  certTransfer: 'certTransfer',
  certissuerInfo: 'certissuerinfo',
  certInfo: 'certinfo',
  certissuerList: 'certissuerlist',
  certissuerFilter: 'certissuerfilter',
  certissuerHistory: 'certissuerhistory',
  certissuerScan: 'certissuerscan'
};
